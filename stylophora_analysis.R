...
setwd("C:/Users/33677/Documents/NEW_WORK/Postdoc LYON/Stylophora Colonialism/Stylophora_Colonialism")
...
ggsave(file="Fig3_holotypes.jpeg", plot=ggholotypes, width=16, height=9, units="cm")
